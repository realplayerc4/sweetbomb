...
class TestRealSenseAPIIntegration:
    ...
    def test_webrtc_offer_rs(self, real_rs_manager):
        """Test creating WebRTC offer with real device"""
        import importlib
        import sys
        ...
        stream_config = {
            "configs": [
                {
                    "sensor_id": "0", # Will be resolved to first sensor usually or need logical id
                    "stream_type": "depth",
                    "format": "z16",
                    "resolution": {"width": 640, "height": 480},
                    "framerate": 30
        ...
        # Need correct sensor_id. Get seeds from device.
