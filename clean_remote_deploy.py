...
def clean_and_install():
    ...
    try:
        ...
        run_sudo_cmd(client, "cd /home/yq/sweetbomb/rest-api && python3.10 -m venv venv", password)
        run_sudo_cmd(client, "cd /home/yq/sweetbomb/rest-api && ./venv/bin/python -m pip install --upgrade pip", password)
        print("Installing Backend Requirements...")
        run_sudo_cmd(client, "cd /home/yq/sweetbomb/rest-api && ./venv/bin/python -m pip install -r requirements.txt", password)

        print("Setting up Frontend...")
        run_sudo_cmd(client, "cd /home/yq/sweetbomb/rest-api/ui/frontend && npm install --registry=https://registry.npmmirror.com", password)
        run_sudo_cmd(client, "cd /home/yq/sweetbomb/rest-api/ui/frontend && npm run build", password)
