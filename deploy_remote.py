...
def deploy():
    ...
    try:
        ...
        setup_cmds = [
            "cd sweetbomb/rest-api && python3.10 -m venv venv",
            "cd sweetbomb/rest-api && ./venv/bin/python -m pip install --upgrade pip",
            "cd sweetbomb/rest-api && ./venv/bin/python -m pip install -r requirements.txt"
        ]
        ...
        npm_cmds = [
            "cd sweetbomb/rest-api/ui/frontend && npm install --registry=https://registry.npmmirror.com"
        ]
        for cmd in npm_cmds:
