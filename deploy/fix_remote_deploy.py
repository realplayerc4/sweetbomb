...
def fix_and_redeploy():
    ...
    try:
        ...
        time.sleep(2)
        client.exec_command("cd sweetbomb && ./venv/bin/python -m pip install --upgrade pip")
        ...
        stdin, stdout, stderr = client.exec_command("cd sweetbomb/ui/frontend && npm install --registry=https://registry.npmmirror.com")
