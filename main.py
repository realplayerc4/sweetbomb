...
tcp_server: RobotTCPServer | None = None
...
# --- WebSocket Root Handler ---
@app.websocket("/ws/robot")
async def robot_ws_root_endpoint(websocket: WebSocket, robot=Depends(get_robot_controller)):
    """处理前端硬编码的机器人连接状态 WebSocket。"""
...
async def startup_event():
    ...
    # 启动机器人 TCP 服务器 (端口9090)
    tcp_server = RobotTCPServer(host="0.0.0.0", port=9090)
